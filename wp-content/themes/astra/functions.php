...
function disable_toolbar($show_admin_bar) {
...
add_filter('show_admin_bar', 'disable_toolbar');
function ajouter_permission_suppression() {
    $role = get_role('secretaire');
    if ($role && !$role->has_cap('delete_users')) {
        $role->add_cap('delete_users');
    }
	$rolee = get_role('psychologue');
    if ($rolee && !$rolee->has_cap('delete_users')) {
        $rolee->add_cap('delete_users');
    }
}
add_action('init', 'ajouter_permission_suppression');